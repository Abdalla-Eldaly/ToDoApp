                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildScreenTitle(
                              context,
                              screenTitle: "task done".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.taskDoneScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "task delete".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.taskDeleteScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "add new task".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.addNewTaskScreen),
                            ),
                            _buildScreenTitle(
                              context,
